...
(async () => {
  ...
  console.log('  -> android-icon-foreground.png (512x512 transparent, safe area)');
  ...
  console.log('  -> android-icon-monochrome.png (512x512 themed)');
  ...
  console.log(`\nDone. Brand bg: ${BG_HEX}, Splash bg: ${SPLASH_BG_HEX}`);
  console.log('Run `npx expo prebuild --clean` to regenerate native icon resources.');
})();
