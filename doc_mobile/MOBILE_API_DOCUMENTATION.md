...
```typescript
{
  ...
  description: string;
  category_id: number;
  product_type: 0 | 1 | 2; // 0=Thing, 1=Car, 2=Work
  is_free: boolean;
...
### Connection
**Hub URL:** `http://46.8.176.21/chathub`

**Connection with JWT:**
```typescript
const connection = new signalR.HubConnectionBuilder()
  .withUrl("http://46.8.176.21/chathub", {
