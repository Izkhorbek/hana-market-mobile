...
> muvofiqlik + tayyor mahsulot — PTA uchun aynan shu uchtasi kuchli.
...
**So'zlovchi:** "Marketplace odam oyiga bir-ikki marta ochadi. Gaz yoki mahalla ma'lumoti — har kuni. Biz yuqori chastotali qatlam ustiga savdoni qo'yamiz."
...
- ✅ **Xizmat** (usta katalogi, telefon orqali bog'lanish)
- ✅ **Gaz navbati** — jonli tracker (banner, "sizgacha N uy", navbat)
...
- Hukumatning **646-sonli qarori** (2018) gaz ta'minotini majburiy qiladi va raqamli hisob pilotini ko'zda tutadi
...
| | Bir Bir | Mango | **Nebor** |
|---|---|---|---|
| Model | Milliy klassifayd | Carrot klon | **Mahalla OS** |
| Yaqin-atrof | ❌ shahar | ✅ | ✅ |
| Hamjamiyat/mahalla | ❌ | ❌ | ✅ |
| Gaz/kommunal | ❌ | ❌ | ✅ |
...
- 🧪 [Pilot mahalla / dastlabki test natijalari, bo'lsa]

**So'zlovchi:** "Biz g'oya emas, ijro qila oladigan jamoamiz — buni ishlaydigan mahsulot isbotlaydi."
...
*2–5 kishi (PTA sharti). [Tegishli tajriba/yutuqlar]*

**So'zlovchi:** "[Jamoa kuchini 1 jumlada]."
...
*Gaz — kirish nuqtasi. Keyin suv, elektr, mahalla xizmatlari, mahalliy iqtisodiyot — hammasi Nebor'da.*

**So'zlovchi:** "Biz O'zbekistonning har bir mahallasi uchun raqamli operatsion tizim quramiz. Gaz navbati — shunchaki boshlanishi."
